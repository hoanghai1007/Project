...
/*----------------------------------------*/
 ...
 /*----------------------------------------*/
	$('.category-sub-menu li.has-sub > a').on('click', function () {
		// Xóa href của anchor tag
		$(this).removeAttr('href');

		// Tìm parent list item của anchor tag
		var element = $(this).parent('li');

		// Nếu parent list item có class "open", thì ...
		if (element.hasClass('open')) {
			// ... gỡ class "open" khỏi parent list item
			element.removeClass('open');

			// ... gỡ class "open" khỏi tất cả các child list item của parent list item
			element.find('li').removeClass('open');

			// ... ẩn tất cả các submenu của parent list item
			element.find('ul').slideUp();
		} else {
			// ... thêm class "open" vào parent list item
			element.addClass('open');

			// ... mở submenu của parent list item
