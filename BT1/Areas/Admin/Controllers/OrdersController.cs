...
using BT1_project.Models; //nhin thay cac file .cs trong folder Models
...
using BT1_project.Areas.Admin.Attributes; //nhin thay cac file .cs trong folder Attributes
